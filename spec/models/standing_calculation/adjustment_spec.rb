...
RSpec.describe StandingEvent, :type => :model do
  describe 'adjustment calculations' do
    ...
    it 'basic adjustment' do
      ...
      expect(@standing_events_one[1].type).to eq :adjustment.to_s
      ...
      expect(@standing_events_two[1].type).to eq :adjustment.to_s
      ...
      expect(@standing_events_three[1].type).to eq :adjustment.to_s
